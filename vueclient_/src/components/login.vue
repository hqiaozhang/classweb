<template>
  <div class="backlogin">
		<div class="login_box">
			...
			<div>
				<input class="myinput" type="text" autocomplete="off" placeholder="手机号/用户名" v-model="username" />
			</div>
			<div>
				<input @keyup.13="login" class="myinput" autocomplete="off" type="password" placeholder="口令" v-model="password" />
			</div>

...
//项目编译输出目录
const outputPath = 'dist/admin-web'
  ...
  dev: {
    ...
    proxyTable: {
      '/backend': {
        ...
        // target: 'http://weatherprod.waming-air.com:9020', // 开发环境
        // target: 'http://test.aitectcare.com:9020', // 测试环境
        // target: 'http://192.168.0.123:21000', // 联调环境
        // target: 'http://192.168.0.117:20001', // 开发环境
        // target: 'http://192.168.0.117:21000', // 联调环境
